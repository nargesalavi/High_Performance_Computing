...
#define FILE_TRAIN_IMAGE		"./data/mnist/train-images-idx3-ubyte"
#define FILE_TRAIN_LABEL		"./data/mnist/train-labels-idx1-ubyte"
#define FILE_TEST_IMAGE		"./data/mnist/t10k-images-idx3-ubyte"
#define FILE_TEST_LABEL		"./data/mnist/t10k-labels-idx1-ubyte"
...
void foo()
{
	...
	Mat img =  Mat(28,28,CV_8UC1,test_data [0] );
	Mat img2 = Mat(28,28,CV_8UC1,test_data [1] );
	Mat img3 = Mat(28,28,CV_8UC1,test_data [2] );
	Mat img4 = Mat(28,28,CV_8UC1,test_data [3] );
	Mat dst,dst1,dst2;
	hconcat(img, img2, dst1);
	hconcat(img3, img4, dst2);
	vconcat(dst1,dst2,dst);
	imshow( " ", dst ); 
	printf("Some of test images\n");
	waitKey(0);
